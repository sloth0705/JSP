...
<div id="sub">
    ...
    <section class="croptalk">
        ...
        <article>
            <nav>
                <img src="/Farmstory1/images/sub_nav_tit_cate3_tit1.png" alt="농작물이야기"/>
                <p>
            ...
            <section class="list">
		        ...
		        <article>
		            <table>
		                ...
		                <tr>
		                	<td>1</td>
		                    <td><a href="/Jboard1/view.jsp?no=">제목입니다</a>&nbsp;[1]</td>
		                    <td>별명</td>
		                    <td>23-08-17</td>
		                    <td>12</td>
		                </tr>
		        ...
		        <!-- 페이지 네비게이션 -->
		    <div class="paging">
		        <a href="/Jboard1/list.jsp?pg=" class="prev">이전</a>
		        <a href="/Jboard1/list.jsp?pg=" class="num current">1</a>
		        <a href="/Jboard1/list.jsp?pg=" class="next">다음</a>
		    </div>
