    ...
    <div id="container">
        <header>
            ...
            <ul class="gnb">
                ...
                <li><a href="/Farmstory2/board/list.do?pg=1&group=Croptalk&cate=story">농작물이야기</a></li>
                <li><a href="/Farmstory2/board/list.do?pg=1&group=Event&cate=event">이벤트</a></li>
                <li><a href="/Farmstory2/board/list.do?pg=1&group=Community&cate=notice">커뮤니티</a></li>
            </ul>
        </header>